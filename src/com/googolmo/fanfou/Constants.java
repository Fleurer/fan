...
public class Constants {
    ...
    public static final int URL_CONNECTION_TIMEOUT = 15 * 1000;
    public static final int URL_READ_TIMEOUT = 15 * 1000;
    public static final String URL_USER_AGENT = "fanxiao";
}
